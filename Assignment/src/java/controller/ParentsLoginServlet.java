 ...
 * @author DUC
 */
public class ParentsLoginServlet extends HttpServlet {
    ...
    throws ServletException, IOException {
        request.getRequestDispatcher("loginParents.jsp").forward(request, response);
    } 
    ...
    throws ServletException, IOException {
      String student_user = request.getParameter("user");
        String student_pass = request.getParameter("pass");
